...
> 🔴 **v10 强制激活节奏（2026-04-26 起）**：
> - **每客户每周 ≥ 2 篇博客**（硬指标，不是建议；过去 30 天 0 博客的纸面问题必须修复）
> - **每周三 9:00 daily-cron 自动触发提醒**：上周该客户博客是否达 2 篇？没达就当日补
> - **每月 30 号自检**：本月每客户博客 ≥ 8 篇 / 季度 ≥ 24 篇
> - **slash 命令**：`/博客 <客户ID> <主题>` 一行触发
>
